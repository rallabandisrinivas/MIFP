...
proc create_properties_contact {name} { 
	...
	set propCont_id [expr [hm_entityinfo maxid props] + 1]
...
proc meshSet {partId} {
	...
	*clearmark components 1
	...
	# 几何处理
	*createmark solids 1 $solid1
	*createmark solids 2 $solid2
	...
	*createstringarray 3 "pars: post_cln fix_comp_bdr tet_clps='0.100000,1.000000,0' max_size='0,0,1.79769e+308'" \
		"tet: 355 1.3 -1 0 0.8 0 0" "2d: 1 0 4 2.5 0.5 30 1"
	*createmark solids 1 $solid1 $solid2
	*tetmesh solids 1 1 elements 0 -1 1 3
	puts \t网格划分：$cName1
	puts \t网格划分：$cName2
...
proc createContactPair {name masterId slaveId propContId} {
	# 设置接触对
	...
	*setvalue groups id=$ContPairId slaveentityids={sets $slaveId}
...
# 创建SurfSet	
	...
	*setvalue loadsteps id=$::Test::stepId STATUS=2 2287="YES"
	# 1425-分析类型(2：静态)，118-开始增量步，119-总时间，1789-最小增量步，1790-最大增量
	*setvalue loadsteps id=$::Test::stepId STATUS=2 1425=2
	*setvalue loadsteps id=$::Test::stepId STATUS=2 154=1
	*setvalue loadsteps id=$::Test::stepId STATUS=0 118=0.1
	*setvalue loadsteps id=$::Test::stepId STATUS=0 119=1.1
	*setvalue loadsteps id=$::Test::stepId STATUS=0 1789=1e-05
	*setvalue loadsteps id=$::Test::stepId STATUS=0 1790=0.1
	}
